...
lazy_static! {
    ...
    pub(crate) static ref K0_POLY: [f64; 8] = [
    ...
    pub(crate) static ref I0_POLY: [f64; 7] = [
    ...
    pub(crate) static ref AK0_CHEB: ChebSeries<f64> = ChebSeries {
        coeffs: vec![
    ...
    pub(crate) static ref AK02_CHEB: ChebSeries<f64> = ChebSeries {
        coeffs: vec![
